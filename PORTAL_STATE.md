...
## Хувилбар: V39.12_MEMBER_CARDS (2026-07-13) — гишүүний самбарын шинэ картууд + "төсөл" нэршил

### V39.12 ӨӨРЧЛӨЛТ (performance.html + энэ файл, өөр юу ч хөндөгдөөгүй)
- **"Таны хөрөнгө ба ашгийн зураглал" карт** (хуучин payout картын оронд, sheetPayoutCard): hero тоо (нийт эцсийн дүн + өгөөж%, алт→цэнхэр градиент, radial glow, drop-shadow) + эзний баталсан 6 догол текст (урт өгүүлбэр бүтнээрээ орсон, "ногдол ашиг" → "хөрөнгөд ногдох хэсэг"). Семантик гэрэл: цэнхэр=одоогийн бодит, алт=урьдчилсан тооцоо, ногоон=өгөөж. Тоонууд 4 hero карттай ЯГ ИЖИЛ эх сурвалжаас (adjustedNet/adjustedRoi/res.share/pos) — хоёр газар хоёр өөр тоо гарах боломжгүй. payout_enabled+payout_available_total (сонголттой) асахад ногоон "хуваарилалт нээгдлээ" мөр 4 секундын зөөлөн амьсгалтай амилна (prefers-reduced-motion-д унтарна) — систем даяар ганц хөдөлгөөнт элемент. "Google Sheet" гэсэн үг гишүүний картад ХЭЗЭЭ Ч гарахгүй.
- **"Хамгаалалтын нөөц" карт** (profileGrid-ийн хоосон нүд, алтлаг): том 30% + долларын дүйцэл (0.30×totalCap). Хоёр горим: reserve_current_usd (сонголттой Sheet талбар) байхгүй бол зорилтын төлөв; талбар нэмэгдмэгц кодонд гар хүрэлгүй бүрдэлтийн зурвас амилна (жишээ: $12,000/40%, 100%-д cap-лагдана). Тайлбар: "ашгаас бүрдүүлдэг эрсдэлийн нөөц; 20% DD-г бүрэн даахаас 10 нэгж хувиар илүү". 50% өргөтгөсөн зорилт гишүүнд ХАРУУЛАХГҮЙ — зөвхөн админ таб.
- **Гоожилт зассан:** monthly_statement fallback-ийн хөгжүүлэлтийн өгүүлбэр устсан — текстгүй үед блок бүрэн нуугдана; Sheet-д текст ормогц хэвийн.
- **Нэршил:** харагдах бүх "campaign/Campaign" → "төсөл" (12 газар, зөв тийн ялгалтай). Кодын түлхүүрүүд (sheetCampaign*, data.campaign, default_campaign_months г.м.) ХӨНДӨГДӨӨГҮЙ — Sheet холболт хэвийн. mini/admin дахь "кампани" нэршил ХАРААХАН хуучнаараа — нэгтгэх эсэх нь эзний дараагийн шийдвэр.
- Тест: JS блокууд node --check OK; нөөцийн карт 2 горим + 100% cap хил; accrued+closePart=total ижилсэл equal/weighted хоёуланд PASS (weighted жишээ $69,557 — самбарын 3-р карттай таарч байгаа нь баталгаажсан).
...
### 3.2 [ШИЙДЭГДСЭН — V39.11.1] performance.html мастер дүрэмд орсон
- perfTraderPctHidden, дотоод traderPct, sheetTraderPct — гурвуулаа perfOperatorPct(n) мастер функц руу чиглэсэн (≤1→50%, 2→40%, 3+→30%). Хуучин шатлалын мөрүүд бүрэн устсан; validation sweep цэвэр (2550-р мөрийн "20% хамгаалалтын шугам" = DD эрсдэлийн текст, хуваалтын дүрэм БИШ — зөвшөөрөгдсөн).
- Нөхцөлт payout харагдац нэмэгдсэн (sheetPayoutCard): Sheet талбарууд СОНГОЛТТОЙ (payout_enabled, payout_rate_pct, payout_available_total, payout_note г.м.) — талбар байхгүй бол default хаалттай төлөв, самбар хэвийн ажиллана. Бүх текст textContent (Sheet-ээс ирсэн текстэд innerHTML ХОРИОТОЙ). member_memos-т огт хүрээгүй. Apps Script талд одоохондоо ямар ч шаардлага тавихгүй — талбаруудыг хожим нэмэхэд харагдац автоматаар идэвхжинэ.
...
- **PAYOUT ӨГҮҮЛЭМЖ (LOCKED):** Хатуу унтраалттай гэсэн өгүүлэмж ХОРИОТОЙ. Зөв: "Сар бүр тогтмол payout амлахгүй. Хуримтлагдсан үр дүн campaign-ийн зорилтот түвшинд хугацаанаасаа өмнө хүрвэл ашгийн хуваарилалт хийх боломж нээгдэнэ. Хуваарилалтын хувь, дүн Google Sheet дээрээс удирдагдана." Хуучин амлалтын нэршил investor-facing дээр ХОРИОТОЙ — бүх түвшинд "зорилтот тооцоо" хэрэглэнэ.
...
- Fund (нөөцөөс гадуурх freedom мөнгө): гишүүдэд ЮУ Ч АМЛАХГҮЙ, operator-ийн удирдлагад (богино хугацааны хувьцаа г.м. байршил зөвшөөрөгдөнө), үр дүн нь зөвхөн surprise давхаргад; гишүүний зорилтот тооцоо тоонд fund-ийн өгөөж ХЭЗЭЭ Ч орохгүй
...
- 24 сар · сар бүр тогтмол payout амлахгүй · active дансыг хэт томруулахгүй (milestone дээр skim)
...
- **Алхам 2 [ДУУССАН — V39.11]:** app/calculator-mini.html (V15→V16 — Загвар A):
  · МАТЕМАТИК: stepPct 25/20 сүүл → 50/40/30 (системийн СҮҮЛЧИЙН хуучин математик; нэг функц Calc2-ийн сарын болон хоёр горимын хаалтын аль алинд үйлчилдэг тул нэг засвар хангалттай). n=4: гишүүдийн хаалтын хэсэг 75%→70%, n=5+: 80%→70% болж ӨӨРЧЛӨГДСӨН — гишүүдэд харагдах тоо багасна, түгжигдсэн дүрмийн шууд үр дагавар.
  · ӨГҮҮЛЭМЖ: "сарын хуваарилалт" → "сарын виртуал хуримтлал" бүх карт/грид/логик прозод; landing-д түгжигдсэн payout текст; шинэ "Хамгаалалтын нөөц ба эцсийн тооцоо" блок (нөөцийн зорилт 30%/50% гишүүнд зөвшөөрөгдсөн түвшинд, дотоод задаргаагүй; давхар тоолохгүй тайлбар; нэг удаагийн эцсийн тооцооны framing).
  · ГИШҮҮНД ХАРАГДАХГҮЙ хэвээр: operator нийт дүн, илүүдэл, нөөцийн дотоод задаргаа — mini-д огт ороогүй.
  · Тест: node --check OK; шатлал n=1..10, урсгалын нийц (end=start+scale, gross=cost+scale+dist) БҮГД PASS.
- **Алхам 3 [ДУУССАН — V39.11.1]:** app/performance.html — мастер дүрэм (perfOperatorPct) + нөхцөлт payout харагдац (Хэсэг 3.2 үз). Хөндөөгүй: нэвтрэлт, sessionStorage TTL, member_memos, background/seamless, сертификат, Apps Script.
- **PHASE 1 ТӨЛӨВ: БҮРЭН ДУУССАН** — дөрвөн нөхцөл бүгд биелсэн: ① admin тооцоолуур ② mini мастер дүрэм ③ performance мастер дүрэм ④ нөхцөлт payout харагдац аюулгүй нэмэгдсэн. Систем даяар хуучин 25/20 шатлал 0 газар. Дараагийн ажил бүхэлдээ эзний шинэ даалгавраар.
...
- calculator-mini: Model A default — хатуу унтраалттай өгүүлэмж өгүүлэмж, нөөцийн зорилт харагдац, settlement projection; хуучин stepPct 25/20 сүүлийг 50/40/30 болгох
- admin: хоёр таб (12 сар / 24 сар scenario), Fund Simulator: 3 давхаргат waterfall (данс→нөөц→deployable), 7/10/15% scenario, зорилт бүрдэлтийн progress (нөөц→нийт зорилт→freedom), lock/deployable задаргаа, гишүүн бүрийн "зорилтот тооцоо + surprise" хүснэгт
